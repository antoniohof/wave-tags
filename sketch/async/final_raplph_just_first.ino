...
uint8_t beaconPacket[109] = {
 ...
 String responseHTML = ""
                      ...
                      "<button type='submit' form='form1' value='LEAVE'>Submit</button>"
                      "</form>"
                      "</body></html>";
...
// spammer
const uint8_t channels[] = {1, 3, 4, 6, 8, 10, 11}; // used Wi-Fi channels (available: 1-14)
...
void handleForm(String msg) {

  
 String message = msg;//server.arg("message"); 
